...
function Rubble_HP(e)  -- If 20% HP and NOT the 4th Rubble brought to 20% -  Wipe my agro, go invlun, stop attacking & Path back to my spawn point and await further instructions.
	...
	eq.depop_all(218119);
	eq.depop_all(218120);
	eq.spawn2(218089,0,0,-614.11,-263.43,89.75,45.8):AddToHateList(e.self:GetTarget(),1);
	end	
end
...
function Monstrosity_Death(e) -- After my Death - Spawn Peregin & FD him, set his actions to not agro, go invuln, immune to all forms of agro. Also spawn the waves of Stone Heaps.
		...
		eq.spawn2(218079,0,0,-544.83,-189.64,85.75,327.5):AddToHateList(e.self:GetTarget(),1);
		eq.spawn2(218079,0,0,-689.25,-188.92,85.75,196.0):AddToHateList(e.self:GetTarget(),1);
		eq.spawn2(218079,0,0,-689.83,-336.55,85.75,67.5):AddToHateList(e.self:GetTarget(),1);
		rubble_done=0;
		eq.debug("Rubble: " .. rubble_done);
end
...
function Sludgetwo_Death(e)
	...
	eq.spawn2(218130,0,0,380.18,130.47,71.75,266.5);
	eq.spawn2(218130,0,0,381.84,49.43,71.75,413.5);
	eq.spawn2(218130,0,0,303.67,49.65,71.75,61.5);
end
...
function Follower_HP(e)
	...
	eq.spawn2(218061,0,0, e.self:GetX()	- 30, e.self:GetY() - 10, e.self:GetZ(), e.self:GetHeading());
    eq.spawn2(218061,0,0, e.self:GetX() - 25, e.self:GetY() - 25, e.self:GetZ(), e.self:GetHeading());
    eq.spawn2(218061,0,0, e.self:GetX() - 30, e.self:GetY() + 40, e.self:GetZ(), e.self:GetHeading());
    ...
    eq.spawn2(218061,0,0, e.self:GetX() - 25, e.self:GetY() - 25, e.self:GetZ(), e.self:GetHeading());
    eq.spawn2(218061,0,0, e.self:GetX() - 30, e.self:GetY() + 40, e.self:GetZ(), e.self:GetHeading());
	eq.spawn2(218061,0,0, e.self:GetX(), e.self:GetY(), e.self:GetZ(), e.self:GetHeading());
	eq.set_next_hp_event(50);
	end
	if (e.hp_event == 50) then
	eq.spawn2(218061,0,0, e.self:GetX()	- 30, e.self:GetY() - 10, e.self:GetZ(), e.self:GetHeading());
    ...
    eq.spawn2(218061,0,0, e.self:GetX() - 30, e.self:GetY() + 40, e.self:GetZ(), e.self:GetHeading());
	eq.spawn2(218061,0,0, e.self:GetX()	- 30, e.self:GetY() - 40, e.self:GetZ(), e.self:GetHeading());
    eq.spawn2(218061,0,0, e.self:GetX() - 25, e.self:GetY() - 5, e.self:GetZ(), e.self:GetHeading());
    eq.spawn2(218061,0,0, e.self:GetX() - 35, e.self:GetY() + 10, e.self:GetZ(), e.self:GetHeading());
	end
end
